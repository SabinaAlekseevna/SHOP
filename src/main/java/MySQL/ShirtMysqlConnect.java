/**
 * Подключение к MySQL для окна приложения "Футболки".
 * @author SabinaTanya
 */
package MySQL;
 ...
 */
public class ShirtMysqlConnect extends MySQLConnect{
    static Logger logger = LoggerFactory.getLogger(ShirtMysqlConnect.class);
    /**
    ...
    public static ObservableList<Product> getDataProduct(){
        ...
        try {
            PreparedStatement ps = con.prepareStatement("select * from shop_clothes where name_product = 'Футболка' order by size_product");
