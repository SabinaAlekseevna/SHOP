/**
 * Подключение к MySQL для окна приложения "Брюки".
 * @author SabinaTanya
 */
package MySQL;
 ...
 */
public class TrousersMysqlConnect extends MySQLConnect{
    static Logger logger = LoggerFactory.getLogger(TrousersMysqlConnect.class);
    /**
    ...
    public static ObservableList<Product> getDataProduct(){
        ...
        try {
            PreparedStatement ps = con.prepareStatement("select * from shop_clothes where name_product = 'Брюки' order by size_product");
