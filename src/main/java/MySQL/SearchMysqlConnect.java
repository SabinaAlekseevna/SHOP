/**
 * Подключение к MySQL для окна приложения "Поиск".
 * @author SabinaTanya
 */
package MySQL;
 ...
 */
public class SearchMysqlConnect extends MySQLConnect{
     static Logger logger = LoggerFactory.getLogger(SearchMysqlConnect.class);
    /**
